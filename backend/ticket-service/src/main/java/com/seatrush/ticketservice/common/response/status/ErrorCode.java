...
public enum ErrorCode {
    ...
    PAYMENT_RESULT_MISMATCH(HttpStatus.CONFLICT, "RESERVATION006", "결제 결과가 예매 정보와 일치하지 않습니다."),
    PAYMENT_RESULT_STATE_CONFLICT(HttpStatus.CONFLICT, "RESERVATION007", "결제 결과가 현재 예매 상태와 충돌합니다.");
