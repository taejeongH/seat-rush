...
$queries = [ordered]@{
    ...
    'queueHeartbeatP95' = "histogram_quantile(0.95, sum by (le) (increase(seat_rush_business_duration_seconds_bucket{mode=`"practice`",result=`"success`",operation=`"queue.heartbeat`"}[$window])))"
