...
*배포 및 부하 테스트를 구동한 뒤 실측 수치를 기록할 예정です.*

| 지표 | 개선 전 (중앙값) | 개선 후 (예정) | 변화 |
| --- | ---: | ---: | --- |
| 예매 생성 API p95 | 1,083 ms | *TBD* | *TBD* |
| Ticket Service Facade p95 | 522 ms | *TBD* | *TBD* |
| 중복 예매 Precheck p95 | 166 ms | *TBD* | *TBD* |
| 중복 예매 Transaction Check p95 | 36 ms | *TBD* | *TBD* |
