...
[최적화 후 100명 재측정](../load-test-results/2026-06-22-k6-queue-open-100-users-after-ttl-optimization/README.md)에서 p95 중앙값은 대기열 진입 606ms, 내 순번 조회 588ms, entryToken 발급 748ms로 확인됐습니다.

기준선과 비교하면 각각 58.9%, 53.0%, 32.9% 감소했습니다. 모든 실행에서 100명 전원이 entryToken을 발급받았고 HTTP 실패는 없었습니다.
